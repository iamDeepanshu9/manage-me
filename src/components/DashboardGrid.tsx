...
const TimerWidget = () => (
  <div className="glass rounded-2xl p-6 flex flex-col items-center justify-between widget-shadow transform transition-transform hover:scale-[1.02] duration-300 h-full">
    ...
    <div className="text-5xl font-mono font-medium text-slate-800 dark:text-slate-200 mb-6 tracking-widest">25 : 00</div>
...
const CalendarWidget = () => (
  <div className="glass rounded-2xl p-6 widget-shadow transform transition-transform hover:scale-[1.02] duration-300 h-full">
    <div className="flex justify-between items-center mb-4">
...
const WIDGETS_CONFIG: Record<string, { component: React.FC; defaultClass: string }> = {
  clock: { component: ClockWidget, defaultClass: "col-span-1 md:col-span-2" },
  timer: { component: TimerWidget, defaultClass: "col-span-1 md:col-span-1" },
  task: { component: TaskWidget, defaultClass: "row-span-2 col-span-1 md:col-span-1" },
  music: { component: MusicWidget, defaultClass: "col-span-1 md:col-span-2" },
  spend: { component: MonthlySpendWidget, defaultClass: "col-span-1 md:col-span-1" },
  news: { component: NewsWidget, defaultClass: "col-span-1 md:col-span-1" },
  calendar: { component: CalendarWidget, defaultClass: "col-span-1 md:col-span-1" },
  sticky: { component: StickyNotesWidget, defaultClass: "col-span-1 md:col-span-2" },
};
